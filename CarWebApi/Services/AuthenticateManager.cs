...
namespace Services
{
    public class AuthenticateManager : IAuthenticationService
    {
        ...
        private User? _user;
        public AuthenticateManager(ILoggerService logger, IMapper mapper, UserManager<User> userManager, IConfiguration config)
        {
            _logger = logger;
            _mapper = mapper;
        ...
        {
            var signinCredentials = GetSigninCredebtials();
        ...
        private SigningCredentials GetSigninCredebtials()
        {
